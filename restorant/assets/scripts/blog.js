...
const healthBenefits = document.getElementsByClassName("health-benefits")[0]
let count = 1

function listerBtnFunction(a) {
    listerBtn1.addEventListener("click", function () {
        healthBenefits.style.display = "block"
        healthBenefits.style.display = "flex"
    ...
    listerBtn2.addEventListener("click", function () {
        healthBenefits.style.display = "none"
...
listerBtnFunction(count)

const healthBenefitsButton1 = document.getElementById("healthBenefitsButton1")
const healthBenefitsButton2 = document.getElementById("healthBenefitsButton2")
const healthBenefitsButton3 = document.getElementById("healthBenefitsButton3")
